...
import { testimonials1, testimonials2, testimonials3, testimonials4, testimonials5 } from '../assets/img/images'

class Testimoniaux extends Component {
    render() {
        return (
            <>
